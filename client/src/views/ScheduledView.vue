...
onMounted(() => {
  videoStore.setFilters({ status: 'scheduled' });
});
...
<template>
  <section>
    ...
    <VideoGrid
      ...
      empty-title="No scheduled videos"
      empty-description="Drop new vertical videos into Upload, then schedule them for social posting."
